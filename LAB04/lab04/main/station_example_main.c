...
*/
#define EXAMPLE_ESP_WIFI_SSID     "SongKiet"
#define EXAMPLE_ESP_WIFI_PASS     "0934282579"
...
static void mqtt_app_start(void)
{
    esp_mqtt_client_config_t mqtt_cfg = {
        .uri = "mqtt://lOnpdH4ws4FoAVqgPmVdwNSrE7Y8d69mKmCLSw5aoBnMkDTXNCZ7fHpICbGG7FQF:@mqtt.flespi.io",
    };
